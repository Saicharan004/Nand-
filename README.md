...
genus_script.tcl – this file is written to synthesize the Verilog file.
genus_script_dft.tcl – This file synthesizes the file with the MUX based scan chains
...
## Leakage power: The power consumed by the sub threshold currents and by reverse biased diodes
...
## Internal power: It is any power dissipated within the boundary of a cell. During switching, a
...
## Switching Power: switching power of a driving cell is the power dissipated by the charging and
...
## Total Power: It is the summation of leakage, internal and switching power.
...
## Black Box Testing: It is a testing technique where no knowledge of the internal functionality and
